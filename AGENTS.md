...
- `prettyd/` — the superseded TypeScript daemon; retain it as a legacy compatibility reference, not as current product truth.
...
- `src-tauri/` — the native-client scaffold; it is not the current Go daemon product.
