...
// config so token rotation does not require rewriting Pretty configuration.
type Config struct {
...
func ConfigPath(home string) string {
	return filepath.Join(home, ".config", "pretty", "backup.json")
}
...
// ReadSomewhereToken accepts the somewhere CLI's JSON without binding Pretty
