...
- **Code-signing (Developer ID)** — unsigned rebuilds get a fresh macOS TCC identity and repeat file-access prompts. All Darwin Go binaries and Pretty.app now use the user's Developer ID plus hardened runtime; notarization remains the distribution gate. — signing shipped 2026-07-19 — PROMOTE: no (table stakes)
